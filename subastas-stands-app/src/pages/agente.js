...
const people = [
    {
        ...
        description: 'Es un youtuber, influencer y empresario mexicano. Es una de las figuras más reconocidas de las redes sociales en México y América Latina, con más de 17 millones de suscriptores en su canal de YouTube.',
        socials: [
            {
              name: 'Facebook',
              href: '#',
